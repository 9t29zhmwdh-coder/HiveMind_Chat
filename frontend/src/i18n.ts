...
export const STRINGS = {
  en: {
    ...
    contextHint: "How many recent messages each agent is shown. A room that keeps growing would otherwise exceed the model's context window. 0 sends the whole transcript.",
    contextWhole: "whole transcript",
    contextRecent: "last {n} messages",
    topic: "Topic",
    save: "Save",
    cancel: "Cancel",
    remove: "Remove",
    ...
    searchResults: "matching messages",
  ...
  de: {
    ...
    policy: "Ablauf",
    rounds: "Runden",
    contextLimit: "Kontext",
    contextHint: "Wie viele der letzten Nachrichten jeder Agent sieht. Ein wachsender Raum würde sonst das Kontextfenster des Modells sprengen. 0 schickt den ganzen Verlauf.",
    contextWhole: "ganzer Verlauf",
    contextRecent: "letzte {n} Nachrichten",
    topic: "Thema",
    save: "Speichern",
    cancel: "Abbrechen",
    remove: "Entfernen",
    duplicateRoom: "Duplizieren",
    ...
    searchResults: "passende Nachrichten",
